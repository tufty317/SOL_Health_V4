...
# Current geographical variation for % flu vaccine updake among over 65s during Winter 2022/3
...
FluVacc_London_map3 <- ggplot(FluVacc_London_geog, aes(geometry=geometry, fill=Vacc_Cat)) +
  ...
  scale_fill_manual(values = catgreen4) + 
  labs(title = "% flu vaccine updake among over 65s during Winter 2022/3", 
       subtitle = "",
       caption = paste0("Source: NHS, Chart: GLA demography"))
FluVacc_London_map3
